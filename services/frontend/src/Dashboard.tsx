...
const pageDefinitions: PageDefinition[] = [
  ...
  { page: 'target-landing-zone', label: 'Landing Zone Resource Groups', group: 'Prepare', icon: Cloud, access: 'modify', eyebrow: 'Target networking', title: 'Import landing zone resource groups', description: 'Capture the target landing zone resource groups; the subscription ID and resource group name are parsed from each resource ID.' },
