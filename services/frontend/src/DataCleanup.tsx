...
export default function DataCleanup({ onComplete }: { onComplete: () => void }) {
  ...
  return <div className="page cleanup-page">
    <section className="cleanup-intro">
      ...
      <div className="cleanup-warning"><AlertTriangle size={19} /><span><strong>This operation cannot be undone</strong><small>Landing zone resource groups, networks, sprint placement mappings, Server Assessments, dependency records, import history, and derived dependency totals will be permanently removed.</small></span></div>
    ...
    {showConfirmation && <div className="modal-backdrop" role="presentation"><section className="confirmation-dialog" role="dialog" aria-modal="true" aria-labelledby="cleanup-confirmation-title">
      ...
      <div className="confirmation-warnings">
        <p><strong>Permanent deletion:</strong> Landing zone resource groups, networks, sprint placement mappings, imported Server Assessments, dependencies, import history, and summary totals cannot be recovered.</p>
